...
func knownMethod(method string) bool {
	...
	case comiswire.MethodCapabilityServicesHandshake, comiswire.MethodCapabilityServicesHealth, comiswire.MethodManagedRunsAbandon, comiswire.MethodManagedRunsActivate, comiswire.MethodManagedRunsPutEvidence, comiswire.MethodManagedRunsRelease, comiswire.MethodManagedRunsReport, comiswire.MethodManagedRunsTerminalEvent:
		return true
	default:
		return false
	}
